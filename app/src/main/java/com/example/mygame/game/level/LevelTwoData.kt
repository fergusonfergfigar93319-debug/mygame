...
/**
 * 第二关「冰湖回音谷」：主线可玩关卡。
 * 节奏上比雪松村更强调「宽裂隙 + 高空平台」与巡逻压迫，鱼干与围巾仍承担解法支点。
 */
object LevelTwoData {
    ...
    fun build(worldWidth: Float, worldHeight: Float): LevelContent {
        ...
        val platforms = listOf(
            ...
            Platform(
                ...
                width = tile * 3.4f,
                height = 16f,
                surfaceFriction = 0.24f,
            ),
            Platform(x = tile * 4.55f, y = groundY - worldHeight * 0.26f, width = tile * 1.35f, height = 24f),
            Platform(x = tile * 7.15f, y = groundY - worldHeight * 0.21f, width = tile * 1.65f, height = 24f, surfaceFriction = 0.26f),
        ...
        val blocks = listOf(
            ...
            Block(x = tile * 10.8f, y = groundY - worldHeight * 0.36f, size = blockSize, type = BlockType.Question, reward = BlockReward.Coin),
        ...
        val enemies = listOf(
            Enemy(
                ...
                width = hero * 0.78f,
                height = hero * 0.72f,
                patrolStart = tile * 3.15f,
                patrolEnd = tile * 5.55f,
                speed = 118f,
                kind = EnemyKind.Seal,
            ),
            Enemy(
                x = tile * 8.45f,
                y = groundY - hero * 1.32f,
                width = hero * 0.7f,
                height = hero * 0.54f,
                patrolStart = tile * 7.5f,
                patrolEnd = tile * 10.65f,
                speed = 128f,
                kind = EnemyKind.Owl,
            ),
            Enemy(
                ...
                width = hero * 0.78f,
                height = hero * 0.72f,
                patrolStart = tile * 12.65f,
                patrolEnd = tile * 15.05f,
                speed = 108f,
                kind = EnemyKind.SpikedSeal,
            ),
            Enemy(
                x = tile * 16.85f,
                y = groundY - hero * 1.22f,
                width = hero * 0.68f,
                height = hero * 0.52f,
                patrolStart = tile * 15.95f,
                patrolEnd = tile * 18.45f,
                speed = 122f,
                kind = EnemyKind.Bird,
            ),
        )
        ...
        val presentation = LevelPresentation(
            ...
            introDescription = "冰湖像一面裂开的镜子，把每一步脚步声都放大成回音。\n" +
                "咕咕嘎嘎和团团必须越过更宽的裂隙、更滑的冰面和更紧密的巡逻，才能继续追向北方。",
            failHint = "先抢高位平台，再决定是用长跳抢距离，还是留着护盾硬吃一次压力。",
            victoryTitle = "抵达回声浅滩",
            victoryDescription = "当你们落上回声浅滩时，原本混乱的风声忽然整齐了一瞬，像是远方有人在雾里回应这趟旅程。\n" +
                "高松鹅的足迹继续指向更北的雾堤，而那里，或许正藏着下一个伙伴的消息。",
            chapterPreviewTitle = "第三关预告：北境雾堤（试玩段）",
