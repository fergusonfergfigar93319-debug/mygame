...
- [MainActivity.kt](./app/src/main/java/com/example/mygame/MainActivity.kt)
  仅负责承载 Compose 入口
- [GuguGagaGame.kt](./app/src/main/java/com/example/mygame/game/GuguGagaGame.kt)
  主游戏循环、关卡数据与绘制逻辑
- [GameModels.kt](./app/src/main/java/com/example/mygame/game/GameModels.kt)
  游戏数据模型与枚举
- [GameUi.kt](./app/src/main/java/com/example/mygame/game/GameUi.kt)
  HUD、提示卡、按钮等通用 UI 组件
- [SaveRepository.kt](./app/src/main/java/com/example/mygame/data/SaveRepository.kt)
  统一管理本地存档与进度读写
