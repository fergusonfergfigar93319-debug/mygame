namespace PenguinRun.Game
{
    ...
    public sealed class DifficultyPreset
    {
        ...
        public static readonly DifficultyPreset Easy = new()
        {
            ...
            FirstBossDistance    = 1750f,
            BossInterval         = 1850f,
            BossPatternMinSeconds = 3.2f,
            BossPatternMaxSeconds = 5.0f,
        ...
        public static readonly DifficultyPreset Normal = new()
        {
            ...
            DisplayName          = "普通",
            Tag                  = "NORMAL",
            Description          = "标准跑酷体验，Boss 约 1000 米后出现",
            StartSpeed           = 10f,
            MaxSpeed             = 32f,
            SpeedRampPerMeter    = 0.018f,
            FirstBossDistance    = 1050f,
            BossInterval         = 1250f,
            BossPatternMinSeconds = 2.4f,
            BossPatternMaxSeconds = 3.6f,
        ...
        public static readonly DifficultyPreset Hard = new()
        {
            ...
            DisplayName          = "困难",
            Tag                  = "HARD",
            Description          = "加速更猛，Boss 较晚出现（约 780m 附近），连招仍偏紧",
            StartSpeed           = 13f,
            MaxSpeed             = 40f,
            SpeedRampPerMeter    = 0.026f,
            FirstBossDistance    = 780f,
            BossInterval         = 1080f,
        ...
        public static readonly DifficultyPreset Expert = new()
        {
            ...
            DisplayName          = "专家",
            Tag                  = "EXPERT",
            Description          = "极限速度；Boss 出现略晚于你节奏仍极快，得分翻倍",
            StartSpeed           = 16f,
            MaxSpeed             = 52f,
            SpeedRampPerMeter    = 0.035f,
            FirstBossDistance    = 620f,
            BossInterval         = 920f,
            BossPatternMinSeconds = 1.4f,
            BossPatternMaxSeconds = 2.2f,
